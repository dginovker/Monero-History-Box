var castleKeep = {
    ...
    makeWalledOffZombieWarrior : function(){
        var NRG = 150 + random.getRandomIntUpTo(10) * 10;
        return land.createMob("WZW", NRG, NRG, "cursed gpu", "A walled off zombie warrior. He probably did something bad to end up here.", [drops.createDrop("hashes", random.getRandomIntUpTo(1) * 4000), drops.createDrop("object", "oldAmulet", true)]);
    },
